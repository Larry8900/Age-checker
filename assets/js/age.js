...
// input fields
    ...
    var inputLet = document.getElementById("year").value;
    //(year_input.value.toString());
    console.log(inputLet);
...
// console.log(new Date(year + ageYear, month, 0).getDate());
...
function calDate() {
    ...
    var userMonth = parseInt(month_input.value);
    var userYear = parseInt(year_input.value);
    var monthsn = document.getElementById("monthh");
    var daysn = document.getElementById("dayy");
    var yearssn = document.getElementById("yearss")
    ...
    if (userMonth < currentMonth){
    ...
    }else if (userMonth == currentMonth && (userMonth === 1 ||
        userMonth === 3 ||
        userMonth === 5 ||
        userMonth === 7 ||
        userMonth === 8 ||
        ...
        userMonth === 12))
        {
            if (userDay <= currentDay) {
                ...
                resultingDay = Math.abs((userDay - currentDay) - 31);
                resultingMonth = 11;
                resultingYear = Math.abs(currentYear - userYear)- 1;
            }
        } else if(userMonth == currentMonth && (userMonth === 4 ||
            userMonth === 6 ||
            userMonth === 9 ||
            userMonth === 11))
            {
                if (userDay <= currentDay) {
                    ...
                    resultingDay = Math.abs((userDay - currentDay) - 30);
                    resultingMonth = 11;
                    resultingYear = Math.abs(currentYear - userYear)- 1;
                }
            }
            ...
            resultingDay = Math.abs(currentDay - userDay);
            resultingYear = (currentYear - userYear)- 1;
            resultingMonth = Math.abs ((userMonth - currentMonth) - 12);
            
        }


        if (resultingMonth && resultingDay < 2) {
            yearssn.textContent = "years"
            monthsn.textContent = "month";
            daysn.textContent = "day";
        }else if (resultingMonth < 2 && resultingDay > 2){
            monthsn.textContent = "month";
            daysn.textContent = "days";
            yearssn.textContent = "years"
        } else if (resultingDay < 2 && resultingMonth > 2){
            daysn.textContent = "day";
            yearssn.textContent = "years"
            monthsn.textContent = "months";
        } else {
            daysn.textContent = "days";
            yearssn.textContent = "years"
            monthsn.textContent = "months";
